        ...
        <table cellpadding="0" cellspacing="0" width="992px" align="center">
                ...
                <tr>
                        ...
                        <td align="left" class="bb" valign="bottom">
                                <h3 class="uc"><?php __('menu_edit_profile'); ?> &rarr; <?php __('title_account_server'); ?></h3>
                        </td>
                        <td></td>
                </tr>
                <tr>
                        ...
                        <td width="180px" align="right" valign="top" class="bb menux">
                                ...
                                <a href="/account/settings"><div class="menu-sub-a stripe-right uc" style="border-bottom: 2px solid #666;"><?php __('account_settings'); ?></div></a>
                        </td>
